            ...
            <main class="hoc container clear">
                ...
                <div class="content">
                    ...
                    <div class="one_half first">
                        ...
                        <br />
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="cedula" class="etiquetas" ValidationExpression="\d{9,12}" Text="* Cambie los guines por números, deben haber mínimo 9 caracteres" ForeColor="Red"></asp:RegularExpressionValidator>
                        <br />
                        <br />
                    </div>
                    <div class="one_half">
                    ...
                    <div>
                        <div>
                            ...
                            <p>
                                -> Se prohíbe el uso de la razón social "Instituto Tecnológico de Costa Rica" en la publicidad o promoción de la actividad, solamente podrá indicarse con el fin de brindar ubicación del lugar        
                            <p>-> La reservación se efectuará contra el pago del 50% del costo total (Este monto no es reembolsable)</p>

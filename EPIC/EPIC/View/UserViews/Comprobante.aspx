        ...
        <div class="wrapper row3">
            <main class="hoc container clear">
                ...
                <div class="content">
                    ...
                    <br />
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="numeroReservacion" class="etiquetas" ValidationExpression="\d{1,10}" Text="* Ingrese solo digitos" ForeColor="Red"></asp:RegularExpressionValidator>
                    <br />
                    <br />
                ...
                <div id="formFactura">
                    ...
                    <br />
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="telefono" class="etiquetas" ValidationExpression="\d{8}" Text="* Formato esperado 88888888" ForeColor="Red"></asp:RegularExpressionValidator>
                    <br />

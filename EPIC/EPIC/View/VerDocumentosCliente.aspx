<%@ Page Title="" Language="C#" MasterPageFile="~/Inicio.Master" AutoEventWireup="true" CodeBehind="VerDocumentosCliente.aspx.cs" Inherits="EPIC.View.VerDocumentosCliente" %>
            ...
            <header id="header" class="hoc clear">
              ...
              <ul class="clear">
                  ...
                  <li class="active"><a class="drop" href="#">Información Adicional</a>
                      <ul>
                          <li class="active"><a href="VerDocumentosCliente.aspx">Protocolos de emergencia</a></li>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDocumentos" DataKeyNames="id">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Descargar archivo">
                                <ItemTemplate>
                                    <asp:HyperLink ID="descarga" runat="server" NavigateUrl='<%# Eval("id", "~/View/Download.aspx?id={0}") %>' Text="Descargar">
                                    </asp:HyperLink>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>

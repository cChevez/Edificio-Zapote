<%@ Page Title="" Language="C#" MasterPageFile="~/Inicio.Master" AutoEventWireup="true" CodeBehind="RegistrarCursos.aspx.cs" Inherits="EPIC.View.AdministratorViews.RegistrarCursos" %>
    ...
    <body>
                    ...
                    <ul class="clear">
                        ...
                        <li class="active"><a class="drop" href="#">Agregar</a>
                            <ul>
                                ...
                                <li class="active"><a href="RegistrarCursos.aspx">Cursos disponibles</a></li>
                            </ul>
                        </li>
        ...
        <div class="wrapper row3">
            <main class="hoc container clear">
                <h2>Registrar información de cursos</h2>
                <br /><br />
                <div class="first">
                ...
                <div class="first">
                    ...
                    <asp:TextBox ID="descripcion" TextMode="MultiLine" runat="server" Columns="100" Rows="10"></asp:TextBox>
                ...
                <br />
                <div class="first">
                    <asp:Label class="etiquetas" ID="Label1" runat="server" Text="Imagen"></asp:Label>

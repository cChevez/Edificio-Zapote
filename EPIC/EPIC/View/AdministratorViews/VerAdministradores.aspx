<%@ Page Title="" Language="C#" MasterPageFile="~/Inicio.Master" AutoEventWireup="true" CodeBehind="VerAdministradores.aspx.cs" Inherits="EPIC.View.VerAdministradores" %>
    ...
    <body>
        ...
        <div class="wrapper row3">
            <main class="hoc container clear">
                ...
                <br />
                <div>
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="SqlAdministradores" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="id">
                        <Columns>
                    ...
                    <asp:SqlDataSource ID="SqlAdministradores" runat="server" ConnectionString="<%$ ConnectionStrings:ePICsqlConnection %>" SelectCommand="SELECT [id], [nombre], [apellido], [email] FROM [Administrador]"></asp:SqlDataSource>
                </div>
                <br />
                <br />
                <div class="one_third first">
                    <asp:Label class="etiquetas" ID="Label2" runat="server" Text="ID de administrador"></asp:Label>
                    <asp:DropDownList ID="idAdministrador" runat="server" DataSourceID="SqlAdministradoresID" DataTextField="id" DataValueField="id"></asp:DropDownList>
                    <asp:SqlDataSource ID="SqlAdministradoresID" runat="server" ConnectionString="<%$ ConnectionStrings:ePICsqlConnection %>" SelectCommand="SELECT [id] FROM [Administrador]"></asp:SqlDataSource>
                    <br />
                    <br />
                </div>
                <div class="one_third">

<%@ Page Title="" Language="C#" MasterPageFile="~/Inicio.Master" AutoEventWireup="true" CodeBehind="VerCursos.aspx.cs" Inherits="EPIC.View.AdministratorViews.VerCursos" %>
                    ...
                    <ul class="clear">
                        ...
                        <li class="active"><a class="drop" href="#">Ver</a>
                            <ul>
                                ...
                                <li class="active"><a href="VerCursos.aspx">Cursos disponibles</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
        ...
        <div class="wrapper row3">
            <main class="hoc container clear">
                ...
                <div class="one_third first">
                    <asp:Label class="etiquetas" ID="Label2" runat="server" Text="Nombre del curso"></asp:Label>
                    <asp:DropDownList ID="idCurso" runat="server" DataTextField="nombre" DataValueField="id" DataSourceID="SqlCursos"></asp:DropDownList>
                    <br />
                    <br />
                </div>
                <div class="one_third">
